        ...
        <>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-orange-800">
                  Resep diurutkan berdasarkan kecocokan dengan bahan yang kamu miliki
                </p>
                <p className="text-sm text-orange-600">
                  Semakin tinggi persentase, semakin banyak bahan yang sesuai
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 mb-4">
              Menampilkan {currentStats.totalRecipes} resep yang cocok dari {filteredRecipes.length} resep tersedia
            </p>
            <div className="flex justify-center space-x-4">
